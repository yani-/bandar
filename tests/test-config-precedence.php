 ...
 * @link      https://github.com/yani-/bandar/
 */
class TestConfigPrecedence extends PHPUnit_Framework_TestCase
{
    /**
     * [testGlobalConfigVSLocal description]
     *
     * @runInSeparateProcess
     *
     * @return void
     */
    public function testGlobalConfigVSLocal()
    {
        define(
            'BANDAR_VIEW_PATH',
            dirname(__FILE__) . DIRECTORY_SEPARATOR . 'test_views'
        );
        Bandar::setup('invalid');
        ob_start();
